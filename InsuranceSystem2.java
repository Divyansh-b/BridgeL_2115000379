...
public class InsuranceSystem {
  ...
  public static void main(String[] args) throws Exception {
    ...
    manager.addPolicy(new Policy("P1001", "Aditya", sdf.parse("2024-03-10"), "Health", 500.0));
    manager.addPolicy(new Policy("P1002", "Abhay", sdf.parse("2024-04-15"), "Auto", 700.0));
    manager.addPolicy(new Policy("P1003", "Dhruv", sdf.parse("2024-02-25"), "Home", 600.0));
